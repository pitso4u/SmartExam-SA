...
/**
 * Enterprise-grade trial management with server-side tracking and device binding.
...
public class TrialManager {
     ...
     */
    private void startAuthenticatedTrial(@NonNull String uid, @NonNull String deviceHash, @NonNull TrialCallback callback) {
        createTrialRecord(uid, deviceHash, callback);
    }
    ...
    private TrialStatus parseTrialStatusFromDocument(@NonNull DocumentSnapshot document) {
        long trialStart = document.getLong("trial_start") != null ? 
            document.getLong("trial_start") : 0;
        long trialEnd = document.getLong("trial_end") != null ? 
            document.getLong("trial_end") : 0;
